...
--		level_range = {1, 50}, exp_worth=0,
		...
		body = { INVEN = 1000, QS_MAINHAND = 1, QS_OFFHAND = 1, MAINHAND = 1, OFFHAND = 1, BODY=1, HEAD = 1, FINGER = 2, GEM={max = 2, stack_limit = 1} },
...
newTalent{
	...
	cant_steal = true,
	no_unlearn_last = true,
	getHealingFactor = function(self, t) return self:combatTalentLimit(t, 2, 0.4, 1) end,
	...
	info = function(self, t)
		if not self.alchemy_golem then return _t"Improves your golem's proficiency with weapons, increasing its attack and damage. Then Improves your golem's armour training, damage resistance, and healing efficiency." end
